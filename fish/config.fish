...
# i3 
    ...
    alias lbgshibasamurai="killall xwinwrap ; sleep 0.5 ; xwinwrap -g 1920x1080 -fs -ov -ni -s -nf -- mpv -wid WID --loop --no-audio /home/jules/Pictures/backgrounds/live-wallpaper/shibaSamurai.mp4"
    alias lbgfireinspace="killall xwinwrap ; sleep 0.5 ; xwinwrap -g 1920x1080 -fs -ov -ni -s -nf -- mpv -wid WID --loop --no-audio /home/jules/Pictures/backgrounds/live-wallpaper/fireInSpace.mp4"
    alias lbgsakuralake="killall xwinwrap ; sleep 0.5 ; xwinwrap -g 1920x1080 -fs -ov -ni -s -nf -- mpv -wid WID --loop --no-audio /home/jules/Pictures/backgrounds/live-wallpaper/LakeSakura.mp4"
    alias lbgsunset="killall xwinwrap ; sleep 0.5 ; xwinwrap -g 1920x1080 -fs -ov -ni -s -nf -- mpv -wid WID --loop --no-audio /home/jules/Pictures/backgrounds/live-wallpaper/sunset.mp4"
    alias lbgsakura="killall xwinwrap ; sleep 0.5 ; xwinwrap -g 1920x1080 -fs -ov -ni -s -nf -- mpv -wid WID --loop --no-audio /home/jules/Pictures/backgrounds/live-wallpaper/sakura2.mp4"
    alias lbgsakuradrop="killall xwinwrap ; sleep 0.5 ; xwinwrap -g 1920x1080 -fs -ov -ni -s -nf -- mpv -wid WID --loop --no-audio /home/jules/Pictures/backgrounds/live-wallpaper/sakura_drop.mp4"
    alias lbgsamurai="killall xwinwrap ; sleep 0.5 ; xwinwrap -g 1920x1080 -fs -ov -ni -s -nf -- mpv -wid WID --loop --no-audio /home/jules/Pictures/backgrounds/live-wallpaper/samurai.mp4"
    alias lbgspace="killall xwinwrap ; sleep 0.5 ; xwinwrap -g 1920x1080 -fs -ov -ni -s -nf -- mpv -wid WID --loop --no-audio /home/jules/Pictures/backgrounds/live-wallpaper/space.mp4"
